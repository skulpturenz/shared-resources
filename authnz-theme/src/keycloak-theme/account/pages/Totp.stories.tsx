		...
		<KcPageStory
			kcContext={{
				totp: {
					enabled: false,
					totpSecretEncoded:
						"HE4W MSTC OBKU CY2M ONXF OV3Q NYYU I3SH",
				...
				url: {
					totpUrl:
						"http://localhost:8080/realms/myrealm/account/totp",
				},
		...
		<KcPageStory
			kcContext={{
				totp: {
					enabled: true,
					totpSecretEncoded:
						"G55E MZKC JFUD MQLT MFIF EVSB JFLG M6SO",
		...
		<KcPageStory
			kcContext={{
				...
				totp: {
					enabled: false,
					totpSecretEncoded:
						"KZ5H CYTW GBVV ASDE JRXG MMCK HAZU E6TX",
